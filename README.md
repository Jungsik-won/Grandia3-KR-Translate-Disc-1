...
현재 `main`에는 `v0.1` 한글화 추출 완료 작업과 `v0.1.1-test` 시험 배포를 위한 문서·검증 도구가
...
| 패치 파일 | `Grandia3_KR_Disc1_Korean_b4f69d38_full.xdelta` |
| 패치 크기 | `2,128,509,042 bytes` |
| 패치 SHA-256 | `20f9f5b8bbf96631b123db3f1889074d3569d8d44c01192d84593765e780c437` |
...
| 결과 ISO SHA-256 | `b4f69d384ca92bbaf02f1b4ba363eb4f42e0a41b5f67ff864b5ad163a2c5f955` |
...
이 시험판은 완성판이 아니라 실제 게임에서의 추가 검수가 필요한 누적 테스트 빌드입니다.
